...
class $mol_scroller extends $mol.$mol_scroller {
	...
	@ $jin2_grab
	scrollHeight() { return this.prop( () => this.node().get().scrollHeight ) }

	@ $jin2_grab
	scrollWidth() { return this.prop( () => this.node().get().scrollWidth ) }

	@ $jin2_grab
	offsetHeight() { return this.prop( () => (<HTMLElement>this.node().get()).offsetHeight ) }

	@ $jin2_grab
	offsetWidth() { return this.prop( () => (<HTMLElement>this.node().get()).offsetWidth ) }
